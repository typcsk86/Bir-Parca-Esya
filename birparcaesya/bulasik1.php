...
<div class="urungenel">
	<div class="urunImage">
		<div class="urunImageIcerik">
			<img src="beyazesyaImages/bulasik1.jpg" class="urunImagee">
		</div>
	</div>
	
	<div class="urunAciklama">
		<p style="color:black; font-family: monospace; font-weight:bold; font-size: 20px; text-align:center;">
			<input style="width:75%; text-align:center; font-size:17.5px;" type="text" name="urunadi" id="urunadi" value="Arçelik 6233 A+ 3 Programlı Bulaşık Makinesi" READONLY> <br><br>
			<input style="width:25%; text-align:center; font-size:17.5px;" type="text" name="urunfiyati" id="urunfiyati" value="1200" READONLY> TL <br><br><br>
			Arçelik 6233 A+ 3 Programlı Bulaşık Makinesi, konforu sizlere dünya 
			standartlarındaki teknolojisiyle yaşatır. Bulaşık makineleri 
			pratik bir şekilde pırıl pırıl mutfak eşyalarına kavuşmak isteyenlerin tercihidir.
		</p>
	</div>
