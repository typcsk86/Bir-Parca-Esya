...
<link rel="stylesheet" type="text/CSS" href="hakkindadestekstyles.css">
...
<div class="ustmenu">
	...
	<div class="div1">
		<p style="height:90%;width:99%;text-align:center; background-color: #737CA1; opacity: 0.5; color: white; border: 1px solid white; outline:5px solid powderblue; font-weight: bold; font-size: 20px;">
		<span style="font-size:30px;">Hakkımızda</span>
		<br><br>
		Biz Bir Parça Eşya Şirketi olarak ilk önceliğimiz sizlere en uygun fiyatlarda ev eşyası edindirebilmek.
		<br><br><br><br>
		<span>Bize ulaşmak için tayyipcoskun12801@gmail.com mail adresine mail atmanız yeterlidir...</span>
