...
<button class="button button1urunadi" onclick="myFunction1()">Masa</button>
<button class="button button1urunadi" onclick="myFunction2()">Sandalye</button>
<button class="button button1urunadi" onclick="myFunction3()">Masa-Sandalye</button>
</div>

<div class="ustmenuright" id="panel1" style="background-color: white;">
	<div class="ustmenurighticerik1">
		<a href="masa1.php"><img src="masasandalyeImages/masa1.jpg" class="urunImage"></a>
	</div>

	<div class="ustmenurighticerik2">
		<a href="###"><img src="masasandalyeImages/masa2.jpg" class="urunImage"></a>
	</div>
</div>

<div class="ustmenuright" id="panel2" style="background-color: white;">
	<div class="ustmenurighticerik1">
		<a href="sandalye1.php"><img src="masasandalyeImages/sandalye1.jpg" class="urunImage"></a>
	</div>

	<div class="ustmenurighticerik2">
		<a href="###"><img src="masasandalyeImages/sandalye2.jpg" class="urunImage"></a>
	</div>
</div>

<div class="ustmenuright" id="panel3" style="background-color: white;">
	<div class="ustmenurighticerik1">
		<a href="masasandalye1.php"><img src="masasandalyeImages/masasandalye1.jpg" class="urunImage"></a>
	</div>

	<div class="ustmenurighticerik2">
		<a href="###"><img src="masasandalyeImages/masasandalye2.jpg" class="urunImage"></a>
	</div>
</div>
