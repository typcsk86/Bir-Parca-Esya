...
<div class="urungenel">
	<div class="urunImage">
		<div class="urunImageIcerik">
			<img src="masasandalyeImages/sandalye1.jpg" class="urunImagee">
		</div>
	</div>
	
	<div class="urunAciklama">
		<p style="color:black; font-family: monospace; font-weight:bold; font-size: 20px; text-align:center;">
			<input style="width:75%; text-align:center; font-size:17.5px;" type="text" name="urunadi" id="urunadi" value="Sera Home İpek Kadife Kılıflı Sandalye" READONLY> <br><br>
			<input style="width:25%; text-align:center; font-size:17.5px;" type="text" name="urunfiyati" id="urunfiyati" value="150" READONLY> TL <br><br><br>
			Farklı Düz Renk Seçeneklerimizle 1. Sınıf İPEK KADİFE Kumaşlarımız ile Hizmetinizdeyiz.
			Kumaş Özelliği Sayesinde Sandalyenizi Sararak Şık bir Görüntü Sağlar.
		</p>
	</div>
