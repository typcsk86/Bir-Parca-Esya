...
<div class="urungenel">
	<div class="urunImage">
		<div class="urunImageIcerik">
			<img src="masasandalyeImages/masasandalye1.jpg" class="urunImagee">
		</div>
	</div>
	
	<div class="urunAciklama">
		<p style="color:black; font-family: monospace; font-weight:bold; font-size: 20px; text-align:center;">
			<input style="width:75%; text-align:center; font-size:17.5px;" type="text" name="urunadi" id="urunadi" value="Mars Mobilya Roma Siyah Tel Ayaklı Mutfak Masa Sandalye Takımı" READONLY> <br><br>
			<input style="width:25%; text-align:center; font-size:17.5px;" type="text" name="urunfiyati" id="urunfiyati" value="450" READONLY> TL <br><br><br>
			Mars Mobilya Roma Tel Ayaklı Mutfak Masası Ürün Bilgileri: Yükseklik : 75 cm, Genişlik : 70 cm, Derinlik : 70 cm.
		</p>
	</div>
