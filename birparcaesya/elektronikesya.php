...
<button class="button button1urunadi" onclick="myFunction1()">Televizyon</button>
<button class="button button1urunadi" onclick="myFunction2()">Bilgisayar</button>
</div>

<div class="ustmenuright" id="panel1" style="background-color: white;">
	<div class="ustmenurighticerik1">
		<a href="tv1.php"><img src="elektronikesyaImages/tv1.jpg" class="urunImage"></a>
	</div>

	<div class="ustmenurighticerik2">
		<a href="###"><img src="elektronikesyaImages/tv2.jpg" class="urunImage"></a>
	</div>
</div>

<div class="ustmenuright" id="panel2" style="background-color: white;">
	<div class="ustmenurighticerik1">
		<a href="pc1.php"><img src="elektronikesyaImages/pc1.jpg" class="urunImage"></a>
	</div>

	<div class="ustmenurighticerik2">
		<a href="###"><img src="elektronikesyaImages/pc2.jpg" class="urunImage"></a>
	</div>
</div>
