...
<button class="button button1urunadi" onclick="myFunction1()">Buzdolabı</button>
<button class="button button1urunadi" onclick="myFunction2()">Çamaşır Makinesi</button>
<button class="button button1urunadi" onclick="myFunction3()">Bulaşık Makinesi</button>
</div>

<div class="ustmenuright" id="panel1" style="background-color: white;">
	<div class="ustmenurighticerik1">
		<a href="buzdolabi1.php"><img src="beyazesyaImages/buzdolabi1.jpg" class="urunImage"></a>
	</div>

	<div class="ustmenurighticerik2">
		<a href="###"><img src="beyazesyaImages/buzdolabi2.png" class="urunImage"></a>
	</div>
</div>

<div class="ustmenuright" id="panel2" style="background-color: white;">
	<div class="ustmenurighticerik1">
		<a href="camasir1.php"><img src="beyazesyaImages/camasir1.jpg" class="urunImage"></a>
	</div>

	<div class="ustmenurighticerik2">
		<a href="###"><img src="beyazesyaImages/camasir2.jpg" class="urunImage"></a>
	</div>
</div>

<div class="ustmenuright" id="panel3" style="background-color: white;">
	<div class="ustmenurighticerik1">
		<a href="bulasik1.php"><img src="beyazesyaImages/bulasik1.jpg" class="urunImage"></a>
	</div>

	<div class="ustmenurighticerik2">
		<a href="###"><img src="beyazesyaImages/bulasik2.jpg" class="urunImage"></a>
	</div>
</div>
