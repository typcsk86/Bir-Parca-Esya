...
<div class="urungenel">
	<div class="urunImage">
		<div class="urunImageIcerik">
			<img src="yatakImages/ciftkisilik1.jpg" class="urunImagee">
		</div>
	</div>
	
	<div class="urunAciklama">
		<p style="color:black; font-family: monospace; font-weight:bold; font-size: 20px; text-align:center;">
			<input style="width:75%; text-align:center; font-size:17.5px;" type="text" name="urunadi" id="urunadi" value="Serta Bowery Yatak" READONLY> <br><br>
			<input style="width:25%; text-align:center; font-size:17.5px;" type="text" name="urunfiyati" id="urunfiyati" value="1555" READONLY> TL <br><br><br>
			Sağlam ve dayanıklı sistem, ürünün ömrünü uzatmakla kalmaz. 
			Ekstra yay adediyle, vücut ağırlığını tüm yatak yüzeyine 
			yayarak bedene baskıyı azaltır.
		</p>
	</div>
