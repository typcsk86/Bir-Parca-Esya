...
<div class="urungenel">
	<div class="urunImage">
		<div class="urunImageIcerik">
			<img src="beyazesyaImages/camasir1.jpg" class="urunImagee">
		</div>
	</div>
	
	<div class="urunAciklama">
		<p style="color:black; font-family: monospace; font-weight:bold; font-size: 20px; text-align:center;">
			<input style="width:75%; text-align:center; font-size:17.5px;" type="text" name="urunadi" id="urunadi" value="Arçelik 7103 D A+++ 1000 Devir 7 kg Çamaşır Makinesi" READONLY> <br><br>
			<input style="width:25%; text-align:center; font-size:17.5px;" type="text" name="urunfiyati" id="urunfiyati" value="1500" READONLY> TL <br><br><br>
			Arçelik 7103 D A+++ 7 kg 1000 Devir Çamaşır Makinesi, etkili yıkama özellikleriyle 
			alıcılarının beklentilerini karşılamayı başarıyor. Sunduğu birçok yıkama modu desteğiyle 
			pamuklulardan sentetiklilere; havlulardan perdelere kadar birçok giysi ve ev eşyasının 
			yıkanarak daha hijyenik hale getirilmesine destek oluyor.
		</p>
	</div>
