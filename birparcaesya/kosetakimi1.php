...
<div class="urungenel">
	<div class="urunImage">
		<div class="urunImageIcerik">
			<img src="koltukImages/kosetakimi1.jpg" class="urunImagee">
		</div>
	</div>
	
	<div class="urunAciklama">
		<p style="color:black; font-family: monospace; font-weight:bold; font-size: 20px; text-align:center;">
			<input style="width:75%; text-align:center; font-size:17.5px;" type="text" name="urunadi" id="urunadi" value="Yıldız Mobilya Stile Köşe Takımı" READONLY> <br><br>
			<input style="width:25%; text-align:center; font-size:17.5px;" type="text" name="urunfiyati" id="urunfiyati" value="3500" READONLY> TL <br><br><br>
			Yıldız Mobilya Stile Köşe Takımı, modern duruşu ile ön plana çıkar. 
			Ayrıntıların gücüne dikkat çeken model gri ile ceviz tonlarının 
			uyumunu sergiler. Ev ya da ofislerde kullanabilecek model, 
			minimalist alanlar için ideal bir seçimdir.
		</p>
	</div>
