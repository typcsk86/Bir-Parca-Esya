...
<div class="urungenel">
	<div class="urunImage">
		<div class="urunImageIcerik">
			<img src="dolapImages/gardirop1.jpg" class="urunImagee">
		</div>
	</div>
	
	<div class="urunAciklama">
		<p style="color:black; font-family: monospace; font-weight:bold; font-size: 20px; text-align:center;">
			<input style="width:75%; text-align:center; font-size:17.5px;" type="text" name="urunadi" id="urunadi" value="Hepsi Home Athena 2 Kapılı Yan Modüllü Sürgü Gardırop" READONLY> <br><br>
			<input style="width:25%; text-align:center; font-size:17.5px;" type="text" name="urunfiyati" id="urunfiyati" value="1999" READONLY> TL <br><br><br>
			Malzemeler : Gövdeler sağlığa zararsız kanserojen madde içermeyen Avrupa E1 kalite standartlarında, 
			yonga levhadan üretilmiştir. Yonga levha kalınlığı 16 mm değil 18 mm kalınlığındaki 
			malzemeden üretilmiştir. Kenar Bandı olarak PVC kullanılmaktadır.<br>
			
			Ürün Özellikleri: 
			Ürün Sürgü Kapaklı Gardırop ve Tekli Çekmeceli Dolap Olarak İki ayrı modülden oluşmaktadır. 
			Talep edildiğinde modüller farklı alanlarda birbirinde ayrı olarak kullanılabilir.
		</p>
	</div>
