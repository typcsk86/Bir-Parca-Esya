...
<div class="urungenel">
	<div class="urunImage">
		<div class="urunImageIcerik">
			<img src="digeresyalarImages/perde1.jpg" class="urunImagee">
		</div>
	</div>
	
	<div class="urunAciklama">
		<p style="color:black; font-family: monospace; font-weight:bold; font-size: 20px; text-align:center;">
			<input style="width:75%; text-align:center; font-size:17.5px;" type="text" name="urunadi" id="urunadi" value="Brillant Blackout Karartma Güneşlik Perde" READONLY> <br><br>
			150 TL -> (%50) -> <input style="width:25%; text-align:center; font-size:17.5px;" type="text" name="urunfiyati" id="urunfiyati" value="75" READONLY> TL <br><br><br>
			Brillant Blackout Karartma Güneşlik Perde Pilesiz 100 x 270 cm Siyah
		</p>
	</div>
