...
<div class="ustmenu">
	...
	<div class="div1">
		<p style="height:75%;width:99%;text-align:center; background-color: #737CA1; opacity: 0.5; color: white; border: 1px solid white; outline:5px solid powderblue; font-weight: bold; font-size: 40px;">
		<span style="font-size:50px;">Destek</span>
		<br><br>
		<span>tayyipcoskun12801@gmail.com <br>mail adresine ulaşın..</span>
	    </p>
	</div>
