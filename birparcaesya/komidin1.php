...
<div class="urungenel">
	<div class="urunImage">
		<div class="urunImageIcerik">
			<img src="digeresyalarImages/komidin1.jpg" class="urunImagee">
		</div>
	</div>
	
	<div class="urunAciklama">
		<p style="color:black; font-family: monospace; font-weight:bold; font-size: 20px; text-align:center;">
			<input style="width:75%; text-align:center; font-size:17.5px;" type="text" name="urunadi" id="urunadi" value="Ratolye Ahşap Çekmeceli Komidin" READONLY> <br><br>
			500 TL -> (%20) -> <input style="width:25%; text-align:center; font-size:17.5px;" type="text" name="urunfiyati" id="urunfiyati" value="400" READONLY> TL <br><br><br>
			Tüm ürünlerimiz el yapımı olup doğal ve masif ahşaptan imal edilmektedir. 
			Bu yüzden çok daha uzun ömürlü, dayanıklı ve doğaldır. Seri üretim MDF, suntalem ürünler ile karşılaştırmayınız.
		</p>
	</div>
