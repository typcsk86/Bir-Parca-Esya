...
<div class="urungenel">
	<div class="urunImage">
		<div class="urunImageIcerik">
			<img src="elektronikesyaImages/tv1.jpg" class="urunImagee">
		</div>
	</div>
	
	<div class="urunAciklama">
		<p style="color:black; font-family: monospace; font-weight:bold; font-size: 20px; text-align:center;">
			<input style="width:75%; text-align:center; font-size:17.5px;" type="text" name="urunadi" id="urunadi" value="VESTEL 32inç Smart HD Ready TV 32H9500" READONLY> <br><br>
			...
			Ekran Boyutu Kategori (cm/inç): 32inç/80 cm<br>
			Çözünürlük: HD Ready (1366 x 768)
		</p>
	</div>
