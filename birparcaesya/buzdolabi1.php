...
<div class="urungenel">
	<div class="urunImage">
		<div class="urunImageIcerik">
			<img src="beyazesyaImages/buzdolabi1.jpg" class="urunImagee">
		</div>
	</div>
	
	<div class="urunAciklama">
		<p style="color:black; font-family: monospace; font-weight:bold; font-size: 20px; text-align:center;">
			<input style="width:75%; text-align:center; font-size:17.5px;" type="text" name="urunadi" id="urunadi" value="Arçelik 2476 CEI A++ 580 Lt Kombi Tipi Buzdolabı" READONLY> <br><br>
			<input style="width:25%; text-align:center; font-size:17.5px;" type="text" name="urunfiyati" id="urunfiyati" value="4000" READONLY> TL <br><br><br>
			Çift kapılı şık bir tasarıma sahip olan bu buzdolabı geniş iç hacminin yanında sessiz 
			çalışma performansı ile dört mevsim soğutma ve gıda saklama ihtiyacınızı fazlasıyla karşılıyor.
		</p>
	</div>
