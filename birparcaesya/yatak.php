...
<button class="button button1urunadi" onclick="myFunction1()">Tek Kişilik</button>
<button class="button button1urunadi" onclick="myFunction2()">Çift Kişilik</button>
</div>

<div class="ustmenuright" id="panel1" style="background-color: white;">
	<div class="ustmenurighticerik1">
		<a href="tekkisilik1.php"><img src="yatakImages/tekkisilik1.jpg" class="urunImage"></a>
	</div>

	<div class="ustmenurighticerik2">
		<a href="###"><img src="yatakImages/tekkisilik2.jpg" class="urunImage"></a>
	</div>
</div>

<div class="ustmenuright" id="panel2" style="background-color: white;">
	<div class="ustmenurighticerik1">
		<a href="ciftkisilik1.php"><img src="yatakImages/ciftkisilik1.jpg" class="urunImage"></a>
	</div>

	<div class="ustmenurighticerik2">
		<a href="###"><img src="yatakImages/ciftkisilik2.jpg" class="urunImage"></a>
	</div>
</div>
