...
<button class="button button1urunadi" onclick="myFunction1()">Halı</button>
<button class="button button1urunadi" onclick="myFunction2()">Perde</button>
<button class="button button1urunadi" onclick="myFunction3()">Komidin</button>
</div>

<div class="ustmenuright" id="panel1" style="background-color: white;">
	<div class="ustmenurighticerik1">
		<a href="hali1.php"><img src="digeresyalarImages/hali1.jpg" class="urunImage"></a>
	</div>

	<div class="ustmenurighticerik2">
		<a href="###"><img src="digeresyalarImages/hali2.jpg" class="urunImage"></a>
	</div>
</div>

<div class="ustmenuright" id="panel2" style="background-color: white;">
	<div class="ustmenurighticerik1">
		<a href="perde1.php"><img src="digeresyalarImages/perde1.jpg" class="urunImage"></a>
	</div>

	<div class="ustmenurighticerik2">
		<a href="###"><img src="digeresyalarImages/perde2.jpg" class="urunImage"></a>
	</div>
</div>

<div class="ustmenuright" id="panel3" style="background-color: white;">
	<div class="ustmenurighticerik1">
		<a href="komidin1.php"><img src="digeresyalarImages/komidin1.jpg" class="urunImage"></a>
	</div>

	<div class="ustmenurighticerik2">
		<a href="###"><img src="digeresyalarImages/komidin2.jpg" class="urunImage"></a>
	</div>
</div>
