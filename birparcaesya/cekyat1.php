...
<div class="urungenel">
	<div class="urunImage">
		<div class="urunImageIcerik">
			<img src="koltukImages/cekyat1.jpg" class="urunImagee">
		</div>
	</div>
	
	<div class="urunAciklama">
		<p style="color:black; font-family: monospace; font-weight:bold; font-size: 20px; text-align:center;">
			<input style="width:75%; text-align:center; font-size:17.5px;" type="text" name="urunadi" id="urunadi" value="Evdemo Mira Çekyat Kanepe Gri" READONLY> <br><br>
			<input style="width:25%; text-align:center; font-size:17.5px;" type="text" name="urunfiyati" id="urunfiyati" value="400" READONLY> TL <br><br><br>
			Üründe silinebilir dokuma ithal soho kumaş kullanılmaktadır. Metrekare ağırlığı 480 gramdır.
			Sürtünme mukavemeti 50.000 devir üzeri. Havı düşük yumuşak dokuludur.
		</p>
	</div>
