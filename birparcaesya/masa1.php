...
<div class="urungenel">
	<div class="urunImage">
		<div class="urunImageIcerik">
			<img src="masasandalyeImages/masa1.jpg" class="urunImagee">
		</div>
	</div>
	
	<div class="urunAciklama">
		<p style="color:black; font-family: monospace; font-weight:bold; font-size: 20px; text-align:center;">
			<input style="width:75%; text-align:center; font-size:17.5px;" type="text" name="urunadi" id="urunadi" value="Ahşap Sokağı Epine Metal Ayaklı Çok Amaçlı Ahşap Masa" READONLY> <br><br>
			<input style="width:25%; text-align:center; font-size:17.5px;" type="text" name="urunfiyati" id="urunfiyati" value="1300" READONLY> TL <br><br><br>
			Ahşap Sokağı Epine Metal Ayaklı Çok Amaçlı Ahşap Masa, ahşabın sıcak dokusunu metalin 
			güçlü duruşuyla birleştiren görünümüyle zevkinize uygun bir hale geliyor. İster bir 
			çalışma alanı olarak isterseniz de zevkle yenen yemekleriniz için kullanın Ahşap Sokağı 
			Epine Metal Ayaklı Çok Amaçlı Ahşap Masa, farklı kullanım imkanlarıyla hayatınızı kolaylaştırıyor.
		</p>
	</div>
