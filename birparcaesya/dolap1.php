...
<div class="urungenel">
	<div class="urunImage">
		<div class="urunImageIcerik">
			<img src="dolapImages/dolap1.jpg" class="urunImagee">
		</div>
	</div>
	
	<div class="urunAciklama">
		<p style="color:black; font-family: monospace; font-weight:bold; font-size: 20px; text-align:center;">
			<input style="width:75%; text-align:center; font-size:17.5px;" type="text" name="urunadi" id="urunadi" value="modilayn 110 Cm 2 Kapılı Dolap" READONLY> <br><br>
			<input style="width:25%; text-align:center; font-size:17.5px;" type="text" name="urunfiyati" id="urunfiyati" value="299" READONLY> TL <br><br><br>
			18mm kalınlığında Melamine malzemeden üretilmiştir. 0,4 MM kenar bandı uygulanmıştır.
			Ürün içinde 3 adet raf 4 adet bölme bulunmaktadır.Raflar portatif olduğununda 
			rafları istediğiniz adette kullanarak, alanı genişletebilirsiniz.
			Ürün temizliğini nemli bez ile kolaylıkla yapabilirsiniz.
		</p>
	</div>
