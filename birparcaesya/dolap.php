...
<button class="button button1urunadi" onclick="myFunction1()">Dolap</button>
<button class="button button1urunadi" onclick="myFunction2()">Gardırop</button>
</div>

<div class="ustmenuright" id="panel1" style="background-color: white;">
	<div class="ustmenurighticerik1">
		<a href="dolap1.php"><img src="dolapImages/dolap1.jpg" class="urunImage"></a>
	</div>

	<div class="ustmenurighticerik2">
		<a href="###"><img src="dolapImages/dolap2.jpg" class="urunImage"></a>
	</div>
</div>

<div class="ustmenuright" id="panel2" style="background-color: white;">
	<div class="ustmenurighticerik1">
		<a href="gardirop1.php"><img src="dolapImages/gardirop1.jpg" class="urunImage"></a>
	</div>

	<div class="ustmenurighticerik2">
		<a href="###"><img src="dolapImages/gardirop2.jpg" class="urunImage"></a>
	</div>
</div>
